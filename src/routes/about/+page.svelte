...
<section class="section about-grid">
  <div class="stack">
    ...
    <p>
      We believe in play as a serious tool, discovery as a way of working and
      adding MIDI where it is deemed appropriate.
    </p>
...
<section class="section about-feature panel">
  <div class="about-feature__media">
    <img
      src="/assets/work/prototyping-desk.jpg"
      alt="A hand testing an interactive prototype on a laptop."
      loading="lazy"
      width="1590"
      height="1099"
    />
...
<section class="section">
  <!-- <div class="section-head">
		<div>
			...
			<h2>How we like things to feel.</h2>
		</div>
	</div> -->
...
<style>
  ...
  .about-feature:hover .about-feature__media img {
